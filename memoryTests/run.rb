...
class MemoryTests < Tester::SandboxTester
  ...
  def test_memory_limit
    ...
    memory_limit.each_index do |i|
      rpt = run_sandbox_test(i + 1, { :memory_limit => memory_limit[i] })
  ...
  def test_benchmark
    ...
    puts run_sandbox_test(2)[Constants::PEAK_MEMORY_USED_FIELD]
    puts sep
